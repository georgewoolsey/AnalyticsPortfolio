...
This analysis utilizes the [The National Agricultural Statistics Service (NASS) Quick Stats](https://quickstats.nass.usda.gov/api) data from an on-line database containing official published aggregate estimates related to U.S. agricultural production.
...
t_1981_c1[366]
# plot(1:366, t_1981_c1, type = "l", xlab="day of year", ylab="daily maximum temperature (°C)", main="Daily Maximum Temperature, Iowa County #1")
...
The **rnassqs** package requires a unique access key which can be obtained [here](https://quickstats.nass.usda.gov/api). After acquiring this key, define it in your code session as the variable `my_qs_api_key`. 
